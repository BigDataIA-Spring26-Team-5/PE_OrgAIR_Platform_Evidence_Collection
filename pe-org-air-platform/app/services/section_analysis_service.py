# # # """
# # # SEC Filing Section Analysis Service

# # # Analyzes parsed SEC filings for:
# # # - Section word counts (Risk Factors, MD&A, Business, etc.)
# # # - Keyword mentions (AI, Machine Learning, Automation, Digital, etc.)
# # # """
...
# # #     def analyze_document(self, document_id: str) -> Optional[DocumentAnalysis]:
...
# # #         return self.analyzer.analyze_sections(
# # #             sections=sections,
...
# # #                     results["filings"][filing_type].append(asdict(analysis))
...
# # #         # Define sections for each filing type
# # #         section_map = {
# # #             "10-K": ["item_1_business", "item_1a_risk_factors", "item_7_mda"],
# # #             "10-Q": ["item_2_mda", "item_1a_risk_factors"],
# # #             "8-K": ["item_8_01_other"],
# # #             "DEF 14A": ["executive_compensation", "director_compensation"],
# # #         }
        
# # #         sections = section_map.get(filing_type, [])
# # #         section_display = {s: self.analyzer.get_section_display_name(s) for s in sections}
...
# # #                     if section_name in section_words:
# # #                         section_words[section_name].append(section_stat.get("word_count", 0))
...
#                 for section_stat in filing.get("sections", []):
#                     section_name = section_stat.get("section_name")
#                     # Match section names (handle both old and new naming)
#                     matched_section = None
#                     for s in sections:
#                         if s in section_name or section_name in s or s == section_name:
#                             matched_section = s
#                             break
#                     if matched_section and matched_section in section_words:
#                         section_words[matched_section].append(section_stat.get("word_count", 0))
