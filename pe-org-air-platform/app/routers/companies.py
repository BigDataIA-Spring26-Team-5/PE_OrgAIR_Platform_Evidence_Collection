...
async def list_companies(
    ...
    companies, total = company_repo.get_all(
        page=page,
        page_size=page_size,
...
async def get_company(
    ...
    # 2. Cache miss - fetch from Snowflake
    # Check if company was deleted first
...
async def update_company(
    ...
    # Check industry exists if being changed
...
async def delete_company(
    ...
    # Check if company was already deleted
    if company_repo.is_deleted(id):
        raise_company_deleted()
