...
#     except ImportError:
#         return "unhealthy: snowflake-connector-python not installed. Run: pip install snowflake-connector-python"
...
#         client.ping()
#         client.close()
#         return f"healthy (Host: {redis_host}:{redis_port})"
        
#     except ImportError:
#         return "unhealthy: redis package not installed. Run: pip install redis"
#     except Exception as e:
#         error_msg = str(e)
#         if len(error_msg) > 100:
#             error_msg = error_msg[:100] + "..."
...
#     """Check AWS S3 connection health (bucket-scoped, least privilege)."""
#     try:
#         import boto3
...
#         # Bucket-scoped health check (NO ListAllMyBuckets)
...
#                     "example": {
#                         "status": "healthy",
#                         "timestamp": "2026-01-28T01:19:36.802Z",
#                         "version": "1.0.0",
#                         "dependencies": {
#                             "snowflake": "healthy (User: MY_USER)",
#                             "redis": "healthy (Host: localhost:6379)",
#                             "s3": "healthy (3 buckets)"
#                         }
#                     }
#                 }
#             }
...
#     description="Check health of all dependencies. Returns 200 if all healthy, 503 if any unhealthy.",
# )
...
#     # Consider "healthy" if starts with "healthy"
...
# # Individual health check endpoints for debugging

# @router.get("/health/snowflake", tags=["health"], summary="Check Snowflake connection")
# async def health_snowflake():
#     """Check only Snowflake health."""
...
# @router.get("/health/redis", tags=["health"], summary="Check Redis connection")
...
# @router.get("/health/s3", tags=["health"], summary="Check S3 connection")
# async def health_s3():
#     """Check only S3 health."""
...
# # Debug endpoint to check if env vars are loaded (without exposing secrets)
# @router.get("/health/env-check", tags=["health"], summary="Check environment variables")
...
#             "REDIS_HOST": "✅ Set" if os.getenv("REDIS_HOST") else "⚪ Using default (localhost)",
#             "REDIS_PORT": "✅ Set" if os.getenv("REDIS_PORT") else "⚪ Using default (6379)",
#         },
#         "timestamp": datetime.now(timezone.utc).isoformat()
#     }
